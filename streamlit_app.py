...
with info:
    ...
    with left:
        ...
        if st.session_state.winner == "Draw":
            ...
            st.markdown(f"""<div style="background-color: #68A886;color: white;padding: 0.75rem;border-radius: 8px;border: 1px solid #444;font-size: 1rem;"><b>{st.session_state.current}</b>'s turn.</div>""",unsafe_allow_html=True)
